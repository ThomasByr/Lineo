      ...
      >
        ...
        >
          ...
          <div className="header-row">
              ...
              <div className="view-control-group">
                ...
                <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                  <button
                    ...
                    title={hasSavedPath ? "Save Project" : "Save As to enable quick save"}
                  >
                    <svg
                  ...
                  >
                    ...
                    <span className="control-label" style={{ marginLeft: 0 }}>
                      Auto save
                    </span>
                  </div>
                </div>
            ...
            <h1>
              Linéo <span className="app-version">v{__APP_VERSION__}</span>
            </h1>
            <div className="header-controls">
              ...
              <div className="view-control-group">
                ...
                >
                  <span className="theme-switch-handle">{theme === "light" ? "☀️" : "🌙"}</span>
                </button>
              </div>
              <div className="divider"></div>
              <div className="view-control-group">
          ...
          <div className="app-layout">
            <div className="sidebar" style={{ width: `${sidebarWidth}px` }}>
              <div className="sidebar-tabs">
                ...
                <button className={activeTab === "plot" ? "active" : ""} onClick={() => setActiveTab("plot")}>
                  Plot
                </button>
                <button
